...
export function divBuilding() {
  ...
  for (let i = 0; i < novenyek.length; i++) {
    txt += `<div class="col-lg-3 col-sm-5 col-md-3 card border m-2">`;
    ...
    txt += `<div class="text-center"><button type="button" class="btn btn-outline-success mx-auto mutat">Mutat</button><button type="button" onclick="openModal();currentSlide(${i+1})" class="btn btn-outline-success mx-auto nagyit">Nagyit</button></div></div></div>`;
  }
